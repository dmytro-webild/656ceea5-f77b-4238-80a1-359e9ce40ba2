  ...
  <div id="hero" data-section="hero">
      ...
      mediaItems={[
        ...
        },
        {
          ...
          imageAlt: "steaming bowl of butter chicken",
        },
        {
          imageSrc: "http://img.b2bpic.net/free-photo/delicious-assortment-traditional-roti_23-2149033987.jpg",
          imageAlt: "fresh garlic naan on wooden platter",
        },
        {
          imageSrc: "http://img.b2bpic.net/free-photo/tasty-dumplings-plate-top-view_23-2148249206.jpg",
          imageAlt: "momos tibetan dumplings on plate",
        },
        {
          imageSrc: "http://img.b2bpic.net/free-photo/couple-dinner-exchanging-with-presents_23-2147736713.jpg",
          imageAlt: "intimate restaurant table setting candlelight",
        },
        {
          imageSrc: "http://img.b2bpic.net/free-photo/slice-tasty-tuna-meal-with-glass-white-wine-restaurant_8353-10588.jpg",
          imageAlt: "indian food spread biryani curry",
        },
      ]}
      ...
      products={[
        {
          ...
          name: "Butter Chicken",
          price: "$22.00",
          imageSrc: "http://img.b2bpic.net/free-photo/flat-lay-winter-squash-soup-with-copy-space_23-2148706315.jpg",
          imageAlt: "butter chicken curry bowl",
        },
        {
          id: "p2",
          name: "Veg Biryani",
          ...
          imageAlt: "vegetable biryani rice bowl",
        },
        {
          id: "p3",
          ...
          imageAlt: "tandoori chicken plate",
        },
      ]}
  ...
  <div id="testimonials" data-section="testimonials">
      ...
      testimonials={[
        ...
        },
        {
          id: "t2",
          title: "Perfect spot",
          quote: "Cozy, cute, and authentic. A perfect escape on a cold night.",
          name: "Michael C.",
          role: "Local",
          imageSrc: "http://img.b2bpic.net/free-photo/medium-shot-smiley-woman-restaurant_23-2149250080.jpg",
          imageAlt: "happy diner",
        },
        {
          id: "t3",
          title: "Incredible lunch value",
          quote: "The executive lunch is a steal! Two courses for such a great price.",
          name: "Emily R.",
          role: "Hall of Fame Visitor",
        ...
        },
        {
          ...
          quote: "Really authentic food. The garlic naan arrived steaming hot!",
          name: "David K.",
          role: "Foodie",
          imageSrc: "http://img.b2bpic.net/free-photo/life-after-covid-freedom-concept_23-2149068501.jpg",
          imageAlt: "happy diner",
        },
        {
          id: "t5",
      ...
      faqs={[
        {
          ...
          content: "Our kitchen aims to balance flavors for all tastes. If you love high heat, please let your server know your spice level preference!",
        },
        {
          id: "f2",
          title: "Do you offer a lunch menu?",
          content: "Yes! We offer a popular two-course executive lunch for $16.95 that is a local favorite.",
        },
        {
          id: "f3",
          title: "Should I make a reservation?",
          content: "We recommend reservations for busy nights, especially during Hall of Fame event weekends, to ensure the best experience.",
        },
      ]}
      ...
      faqs={[
        {
          ...
          content: "We are tucked away in a charming alleyway right near the Baseball Hall of Fame.",
        },
        {
          id: "c2",
          title: "What are your hours?",
          content: "We are open daily for lunch and dinner. Check our Google profile or call us for current seasonal hours.",
        },
      ]}
